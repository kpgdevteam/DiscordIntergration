...
{
    private static string _connectionString = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "DiscordIntegration.db");
    ...
    public static void Init()
    {
        ...
        {
            cmd.CommandText = "CREATE TABLE IF NOT EXISTS Watchlist(Id INTEGER PRIMARY KEY AUTOINCREMENT, UserId TEXT, Reason TEXT)";
            cmd.ExecuteNonQuery();
        }
